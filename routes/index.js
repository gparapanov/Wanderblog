...
module.exports = function (app, db) {
    ...
    app.get('/', function (req, res) {
        db.getConnection(function (err, connection) {
            connection.query("SELECT adventure_id,title, ROUND(avg(score),2)as total from rating,adventure where adventure_id=adventure.id group by adventure_id,title order by avg(score) DESC;", function (err, rows) {
