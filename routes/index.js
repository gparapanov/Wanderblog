...
module.exports = function (app, db) {
    ...
    app.get('/', function (req, res) {
        db.getConnection(function (err, connection) {
            connection.query("SELECT adventure_id,title, cast(AVG(score) as total) as decimal(3,1) from rating,adventure where adventure_id=adventure.id group by adventure_id,title order by sum(score) DESC;", function (err, rows) {
